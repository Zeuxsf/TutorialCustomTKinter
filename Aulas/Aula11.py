...
def novatela():
    ...
    btn2 = ctk.CTkButton(nova,text='Ovo',command=comando).pack()
    ctk.CTkLabel(nova,text='Que doideira', font=('arial bold',30)).pack()
    ctk.CTkEntry(nova,text_color='red').pack()


btn = ctk.CTkButton(janela,50,50,text='Clique',image=img,command=comando).pack()
btn3 = ctk.CTkButton(janela,50,50,text='Clique',command=novatela).pack()
